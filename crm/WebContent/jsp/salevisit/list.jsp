										...
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
												...
												<TR>
													<TD>访问时间:从</TD>
													<TD>
													<s:textfield  id="visit_time" theme="simple" cssClass="textbox" cssStyle="WIDTH: 80px" maxLength="50" name="visit_time"></s:textfield>
													</TD>
													<TD>到</TD>
													<TD>
													<s:textfield  id="visit_end_time" theme="simple" cssClass="textbox" cssStyle="WIDTH: 80px" maxLength="50" name="visit_end_time"></s:textfield>
													</TD>
										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR
													...
													<TD><s:date name="visit_nexttime" format="yyyy_MM_dd"/></TD>
